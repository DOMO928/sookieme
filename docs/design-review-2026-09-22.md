...
- **Identity:** a name-led About page with Frontend & Graphics Engineer and a continuous biography in paragraphs, without subsection headings or dividers. Five body paragraphs connect installation art and software, describe intensive startup experience, show curiosity and willingness to learn across disciplines, explain the interest in interaction, and introduce life in Germany and an interest in working across cultures. Career chronology stays in the résumé; work, résumé and contact links follow the narrative.
...
Reference rationale: [Maxime Heckel](https://maximeheckel.com/) for connecting professional background, curiosity and interactive work; [Aras Pranckevičius](https://aras-p.info/) for direct access to graphics work and code. [Josh W. Comeau](https://www.joshwcomeau.com/about-josh/) also informed the connection between background and personal interests. These are structural references, not copied biography, design or source. The final paragraph structure and selected material follow Jaesook’s editorial direction. The maker perspective, startup experience, life in Germany and personal interests were supplied by Jaesook.
